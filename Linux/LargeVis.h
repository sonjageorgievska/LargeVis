...
class LargeVis{
private:
	long long n_vertices, n_dim, out_dim, n_samples, n_threads, n_negatives, n_neighbors, n_trees, n_propagations, edge_count_actual, to_logarithmize; //to_logarithmize added by Sonja;
...
public:
	...
	void run(long long out_d = -1, long long n_thre = -1, long long n_samp = -1, long long n_prop = -1, real alph = -1, long long n_tree = -1, long long n_nega = -1, long long n_neig = -1, real gamm = -1, real perp = -1, long long to_log = -1);//to_log added by sonja
	real *get_ans();
